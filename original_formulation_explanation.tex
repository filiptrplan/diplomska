...
\subsection*{2. Začetne relacije (\textit{Input Relations})}
Te relacije predstavljajo začetni vhod za analizo. Izpeljane so iz analize toka podatkov
v prejsnjih fazah analize.
\begin{itemize}
