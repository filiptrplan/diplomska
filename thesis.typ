...
V nadaljevanju bomo uporabljali dva podobna pojma. _Varen program_ je program, ki ne povzroča pomnilniških napak. _Veljaven program_ pa je program, ki ga Rustova pravila lastništva in izposojanja smatrajo kot varnega. Cilj Rustovega prevajalnika je, da bi bili ti dve množici programov v Rustu enaki, vendar se zaradi neizračunljivosti izkaže, da je vsak veljavni program tudi varen, vendar v Rustu zato žal ni vsak varen program veljaven.
...
Za grajenje intuicije o razlikah med trenutno različico preverjevalnika izposoj (NLL) in med Poloniusom bomo obravnavali motivacijski primer (@listing:mot_ex[program]), ki ga NLL zavrne in Polonius sprejme. Primer je prilagojen iz prvotnega predloga NLL-ja @2094nllRustRFC.
